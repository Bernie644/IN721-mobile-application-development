...
\subsection*{Functionality (Features) - Learning Outcomes 1, 2, 3 (35\%)}
\begin{itemize}
	...
	\item At least \textbf{20} UI tests which verify that your application is functioning correctly.
\end{itemize}
