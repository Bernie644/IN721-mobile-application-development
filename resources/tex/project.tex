...
\begin{tabular}{|l|l|l|l|l|}
	...
	\small Practical                                                        & \small 30\%        & \small 2, 3                                                           & \small CRA                                                                    & \small Cumulative                                                           \\ \hline
	\small Project                                                          & \small 70\%        & \small 1, 2, 3                                                        & \small CRA                                                                    & \small Cumulative                                                           \\ \hline
\end{tabular}

\section*{Conditions of Assessment}
You will complete this assessment during your learner managed time, however, there will be availability during the teaching sessions to discuss the requirements \& your progress of this assessment. This assessment will need to be completed by \textbf{19/11/2021}.
...
\section*{Submissions}
You must submit all program files via \textbf{GitHub Classroom}. Here is the URL to the repository you will use for your submission – \href{https://classroom.github.com/a/YvRoxlAh}{https://classroom.github.com/a/YvRoxlAh}. The latest program files in the \textbf{main} branch will be used to run your application. Late submissions will incur a \textbf{10\% penalty per day}, rolling over at \textbf{5:00 PM}.
...
\begin{itemize}
	...
	\item Application must run without code modification on a mobile device.
	...
	\item Text translation support. If a country is multilingual (use of more than one language), choose one language. For example, Canada's main languages are English \& French. You would choose either English or French.
	      \begin{itemize}
	      	...
	      	\item Display the message \textbf{Loading...} in a \textbf{TextView} while the text is being translated.
	...
	\item An interactive quiz for each country.
	      \begin{itemize}
	      	...
	      	\item A quiz must be completed within a \textbf{3 minute} time limit.
	...
	\item \textbf{Google Map} displaying top-rated tourist attractions.
	      \begin{itemize}
	      	\item Top-rated tourist attraction data must be fetched from a \textbf{GitHub Gist}.
	...
	\item \textbf{Switch} which toggles between light \& dark mode.
	      \begin{itemize}
	      	\item The state (true or false) value of the \textbf{Switch} must be stored in a \textbf{DataStore}.
...
\begin{itemize}
	...
	\item Continuous integration using \textbf{GitHub Actions}.
	      \begin{itemize}
	      	\item \textbf{YAML} file must be configured, UI tests, code formatting, linting \& generating an APK.
	      \end{itemize}  			
