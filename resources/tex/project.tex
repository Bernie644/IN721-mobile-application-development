...
\lfoot{Project\\Version 3, Semester Two, 2021}
\rfoot{\thepage}
...
\section*{Submissions}
You must submit all program files via \textbf{GitHub Classroom}. Here is the URL to the repository you will use for your submission – \href{TBC}{TBC}. The latest program files in the \textbf{main} branch will be used to run your application. Late submissions will incur a \textbf{10\% penalty per day}, rolling over at \textbf{5:00 PM}.
...
\begin{itemize}
	...
	\item Adaptive launcher icon which displays a variety of shapes, i.e. circle \& square.
